...
public class DangKy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtUsername = findViewById(R.id.editText_uername);
        edtPassword = findViewById(R.id.editText_Pass);
        edtRepassword = findViewById(R.id.editText_Respass);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>(){
                    ...
                    public void onResponse(String response)
                    {
                        try {
                            ...
                            {
                                Toast.makeText(getApplicationContext(), "Tài khoản đã được đăng ký rồi", Toast.LENGTH_LONG).show();
                            }
